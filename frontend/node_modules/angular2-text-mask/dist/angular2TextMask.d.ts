...
export declare class MaskedInputDirective implements ControlValueAccessor, OnChanges {
    ...
    static ngDirectiveDef: ɵngcc0.ɵɵDirectiveDefWithMeta<MaskedInputDirective, "[textMask]", ["textMask"], { 'textMaskConfig': "textMask" }, {}, never>;
}
export declare class TextMaskModule {
    static ngModuleDef: ɵngcc0.ɵɵNgModuleDefWithMeta<TextMaskModule, [typeof MaskedInputDirective], never, [typeof MaskedInputDirective]>;
    static ngInjectorDef: ɵngcc0.ɵɵInjectorDef<TextMaskModule>;
}
