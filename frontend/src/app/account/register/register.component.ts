...
export class RegisterComponent implements OnInit {
  ...
  Register(fName: any, lName: any, Login: any, passw: any, numCard: any): void {
    ...
    // this.users.UserRegister(this.firstName, this.lastName, this.newLogin, this.newPassword, this.numberCard);
    // this.users.UserAuthorization(this.newLogin, this.newPassword);
